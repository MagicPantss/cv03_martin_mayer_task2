...
public class CanvasDashed {

    private JFrame frame;
    private JPanel panel;
    private Point point1 = null;
    private RasterBufferedImage img;
    private LineRasterizer lineRasterizer = new DashedLine(1, 1);

    public CanvasDashed(int width, int height) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CanvasDashed(800, 600).start());
    }
