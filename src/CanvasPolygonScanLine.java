...
public class CanvasPolygonScanLine {
    ...
    public CanvasPolygonScanLine(int width, int height) {
        ...
        panel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                if (e.getButton() == MouseEvent.BUTTON3) {
                    Filler scanLine = new ScanLine(lineRasterizer, polygonRasterizer, polygon, img, new RainbowFill(), 0x03bafc);
                    scanLine.fill();
                }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CanvasPolygonScanLine(800, 600).start());
    }
